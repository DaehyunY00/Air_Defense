...
var suites = [
  ...
  ,['c2-state-integrity.test.mjs', 'C2 상태 정합성 (계통별 실패 격리·정보 생성시각/순서·명령 발령자/계보)']
  ...
  ,['command-flow-config.test.mjs', '[지휘 흐름] 실제 설정·집계 (기본 URL 동치·카탈로그 적용·관측 절삭·미해결 분모)']
  ...
  ,['c2-decision-time-parity.test.mjs', 'ADR-099 C2 결심 시간 동일화 (OFF 골든·As-Is bit-exact·IAOC 운용자=KAMD_OPS·To-Be 결심지연 증가·배선)']

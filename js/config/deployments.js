...
const HANBANDO_FULL_C2_BASE = Object.freeze([
  ...
  Object.freeze({ typeId: 'ARMY_LOCAL_AD', posKey: 'ARMY_WEST_FRONT_AD', showNetworkNode: true, instanceLabel: '육군 서부전방 국지방공' }),
  Object.freeze({ typeId: 'ARMY_LOCAL_AD', posKey: 'ARMY_CENTRAL_FRONT_AD', showNetworkNode: true, instanceLabel: '육군 중부전방 국지방공' }),
  Object.freeze({ typeId: 'ARMY_LOCAL_AD', posKey: 'ARMY_EAST_FRONT_AD', showNetworkNode: true, instanceLabel: '육군 동부전방 국지방공' }),
  Object.freeze({ typeId: 'ARMY_LOCAL_AD', posKey: 'ARMY_CAPITAL_AD', showNetworkNode: true, instanceLabel: '수방사 국지방공' }),
  Object.freeze({ typeId: 'ARMY_LOCAL_AD', posKey: 'MARINE_NW_AD', showNetworkNode: true, instanceLabel: '해병 서북도서 국지방공' }),

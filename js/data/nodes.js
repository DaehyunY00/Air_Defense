...
(function () {
  ...
  KJ.NODES = [
    ...
    // ══════════════════════ 무기체계 (Shooter) ══════════════════════
    {
      ...
      engage: { rangeKm: 350, channels: 4, engageTimeSec: 300, pk: { byThreat: { uav_small: { kind: 'triangular', min: 0.1, mode: 0.25, max: 0.4 } }, default: { kind: 'triangular', min: 0.8, mode: 0.8, max: 0.8 }, paramRef: 'WPN-FTR-PK-01' }, costPerShotM: 0.5, costRef: 'WPN-FTR-COST-01', magazine: 120, magRef: 'WPN-FTR-MAG-01' }
    },
    {
      ...
      engage: { rangeKm: 7, channels: 6, engageTimeSec: 60, pk: { byThreat: { uav_small: { kind: 'triangular', min: 0.1, mode: 0.3, max: 0.5 } }, paramRef: 'WPN-SHORAD-PK-01' }, costPerShotM: 0.2, costRef: 'WPN-SHORAD-COST-01', magazine: 200, magRef: 'WPN-SHORAD-MAG-01' },
    ...
    },
    {
      ...
      canEngage: { fighter: true, ac_low: true, heli: true, cruise: true, uav_small: true, srbm: false, mrl_large: false },
      wtaSuit: { low: 1.3, medium: 0.5, ballistic: 0, paramRef: 'C2-WTA-SUIT-01' },
      engage: { rangeKm: 7, channels: 4, engageTimeSec: 60, pk: { byThreat: { uav_small: { kind: 'triangular', min: 0.1, mode: 0.3, max: 0.5 } }, paramRef: 'WPN-SHORAD-PK-01' }, costPerShotM: 0.2, costRef: 'WPN-SHORAD-COST-01', magazine: 150, magRef: 'WPN-SHORAD-MAG-01' },
    ...
    },
    {
      ...
      engage: { rangeKm: 40, channels: 2, engageTimeSec: 90, pk: { default: { kind: 'triangular', min: 0.6, mode: 0.8, max: 0.9 }, paramRef: 'WPN-MSAM2-PK-01' }, costPerShotM: 1.5, costRef: 'WPN-MSAM-COST-01', magazine: 48, magRef: 'WPN-MSAM-MAG-01' }
    },
    {
      ...
      engage: { rangeKm: 40, channels: 4, engageTimeSec: 45, pk: { default: { kind: 'triangular', min: 0.6, mode: 0.8, max: 0.9 }, paramRef: 'WPN-MSAM2-PK-01' }, costPerShotM: 3, costRef: 'WPN-MDUM-COST-01', magazine: 48, magRef: 'WPN-MDUM-MAG-01' }
    },
    {
      ...
      engage: { rangeKm: 150, channels: 3, engageTimeSec: 40, pk: { default: { kind: 'triangular', min: 0.6, mode: 0.75, max: 0.9 }, paramRef: 'WPN-LSAM-PK-01' }, costPerShotM: 8, costRef: 'WPN-LSAM-COST-01', magazine: 24, reserveFloor: { srbm: 6 }, magRef: 'WPN-LSAM-MAG-01' }
    },
    {
      ...
      engage: { rangeKm: 150, channels: 2, engageTimeSec: 50, pk: { default: { kind: 'triangular', min: 0.6, mode: 0.75, max: 0.85 }, paramRef: 'WPN-SM2-PK-01' }, costPerShotM: 2.1, costRef: 'WPN-SM2-COST-01', magazine: 32, magRef: 'WPN-SM2-MAG-01' }
    },
    {

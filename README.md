...
| 플래그 | 기본 | 내용 | ADR |
|---|---|---|
| **`approvalChain`** (+반증 `approvalChainTobe`) | **ON** | As-Is 교전 협조 계선(국지방공 AOC↔MCRC coord 홉 + 협조 처리 서비스 + 동적 위임 — 협조 관계, ADR-098), USFK 제외. **끄면 As-Is 협조 대기가 0으로 표시돼 G6①과 반대 그림**이 됩니다 | ADR-058·065 |
...
- **핵심 결론 불변(G6)**: 모든 변경 후에도 ①교전 협조가 As-Is 핵심 병목, ②To-Be 병목이
...
As-Is 협조몫 18~35초·협조 처리 Wq 40.1초 — **G6 ① As-Is 병목=교전 협조**의 직접 증거이며,

...
const { installIadsKernel } = await import('../model/iads/index.js?v=20260902c');
...
const classicModules = [
  ...
  '../analysis/bottleneck.js?v=20260902c', '../analysis/c2-report.js?v=20260902c', '../engine/sim-engine.js?v=20260902c', '../analysis/mc-runner.js?v=20260902c',
...
await import('./sim-worker-runtime.js?v=20260902c');
